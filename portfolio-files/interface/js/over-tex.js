$(function(){
  ...
  function hideContent(x)
  {
    ...
    $("#" + x).fadeTo(600,0, function(){ $("#" + x).css({"z-index":"-1"}); });
  }

  $("#img_item").hover(
  	function()
    {
      showContent("enchant_id", "_item");
    }
  );
